...
// Source: C:\Users\BaronPipistron\Desktop\GoProject\main\internal\userFeedback\userFeedback.go
...
import (
	context "context"
	userFeedback "gafroshka-main/internal/types/userFeedback"
	userFeedback0 "gafroshka-main/internal/userFeedback"
	reflect "reflect"
...
func (m *MockUserFeedbackRepo) Create(ctx context.Context, userFeedback *userFeedback0.UserFeedback) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserFeedbackRepo) GetByUserID(ctx context.Context, userRecipientID string) ([]*userFeedback0.UserFeedback, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByUserID", ctx, userRecipientID)
	ret0, _ := ret[0].([]*userFeedback0.UserFeedback)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserFeedbackRepo) Update(ctx context.Context, userFeedbackID string, updateUserFeedback userFeedback.UpdateUserFeedback) error {
	m.ctrl.T.Helper()
