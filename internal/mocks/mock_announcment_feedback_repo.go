...
func (m *MockFeedbackRepo) Update(feedbackID string, comment string, rating int) (annfbtype.Feedback, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", feedbackID, comment, rating)
	ret0, _ := ret[0].(annfbtype.Feedback)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFeedbackRepoMockRecorder) Update(feedbackID, comment, rating interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockFeedbackRepo)(nil).Update), feedbackID, comment, rating)
}